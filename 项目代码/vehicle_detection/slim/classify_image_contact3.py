...
def create_graph():
  ...
  with open('./freezen_graph.pb', 'rb') as f:
...
def run_inference_on_image(imageArr,sess,min_score = 0.2):
...
def main(_):
  ...
  run_inference_on_image('./faster_rcnn_nas_lowproposals_coco_2018_01_28/0slice.jpg')
